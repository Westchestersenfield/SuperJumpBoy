...
public class TestState extends Zone{
	
	public static int id = 999; //increment this
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		music = new Music("/assets/sound/music/DarkWoods/forest.ogg");
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
		...
		//g.drawImage(player.getImage(), player.getBody().getX(), player.getBody().getY());
		g.draw(floor);
